...
#### Once downloaded open the zip, open the windows folder, and open Blockopoly. To play locally make sure steam is closed. To play on steam, open steam and login, then start the game.
## About the project
### Motivation
